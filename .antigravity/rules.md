...
## 7. Git Workflow - CRITICAL RULES

⚠️ **NEVER COMMIT TO GITHUB:**

- **`.antigravity/` folder** - This is an internal configuration folder, MUST NOT be committed or pushed to remote
- **`.antigravity/rules.md`** - This file itself MUST NOT be committed to GitHub

If these files/folders appear in `git status`, they should be:

- **EXCLUDED from all commits and pull requests**
- **REMOVED from remote if accidentally pushed** (see removal instructions below)
- Kept local-only for AI agent configuration

---

_End of Rules. Acknowledge context._
